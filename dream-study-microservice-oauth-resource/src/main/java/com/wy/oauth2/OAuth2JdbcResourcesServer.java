...
/**
 * OAuth2数据库资源服务器,如果和认证服务器放在一起报异常,则分开放在不同的项目
 * 
 * 
 * https://blog.csdn.net/qq_37634156/article/details/123347491
 *
 * @author 飞花梦影
...
public class OAuth2JdbcResourcesServer extends ResourceServerConfigurerAdapter {
