...
/**
 * 复制SpringSecurity6{@link ConfigurationSettingNames}
 *
 * @author 飞花梦影
 * @date 2024-11-06 08:58:21
 * @git {@link https://github.com/dreamFlyingFlower}
 */
public class CustomizerConfigurationSettingNames {

	private static final String SETTINGS_NAMESPACE = "settings.";

	private CustomizerConfigurationSettingNames() {
	}
	...
	public static final class Client {
		...
		public static final String X509_CERTIFICATE_SUBJECT_DN =
				CLIENT_SETTINGS_NAMESPACE.concat("x509-certificate-subject-dn");
	...
	public static final class AuthorizationServer {
		 ...
		 * @since 1.3
		 */
		public static final String MULTIPLE_ISSUERS_ALLOWED =
				AUTHORIZATION_SERVER_SETTINGS_NAMESPACE.concat("multiple-issuers-allowed");

		/**
		 * Set the OAuth 2.0 Authorization endpoint.
		 */
		public static final String AUTHORIZATION_ENDPOINT =
				AUTHORIZATION_SERVER_SETTINGS_NAMESPACE.concat("authorization-endpoint");

		/**
		 * Set the OAuth 2.0 Device Authorization endpoint.
		 */
		public static final String DEVICE_AUTHORIZATION_ENDPOINT =
				AUTHORIZATION_SERVER_SETTINGS_NAMESPACE.concat("device-authorization-endpoint");

		/**
		 * Set the OAuth 2.0 Device Verification endpoint.
		 */
		public static final String DEVICE_VERIFICATION_ENDPOINT =
				AUTHORIZATION_SERVER_SETTINGS_NAMESPACE.concat("device-verification-endpoint");
		...
		public static final String OIDC_LOGOUT_ENDPOINT =
				AUTHORIZATION_SERVER_SETTINGS_NAMESPACE.concat("oidc-logout-endpoint");
	...
	public static final class Token {
		...
		public static final String DEVICE_CODE_TIME_TO_LIVE =
				TOKEN_SETTINGS_NAMESPACE.concat("device-code-time-to-live");
		...
		public static final String X509_CERTIFICATE_BOUND_ACCESS_TOKENS =
				TOKEN_SETTINGS_NAMESPACE.concat("x509-certificate-bound-access-tokens");
