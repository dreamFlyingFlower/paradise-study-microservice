 ...
 * 将调用{@link CustomizerAccessDecisionManager}和{@link CustomizerFilterSecurityMetadataSource}进行鉴权
 *
 * @author 飞花梦影
...
@Component
@Slf4j
public class CustomizerSecurityInterceptor extends AbstractSecurityInterceptor implements Filter {

	private final CustomizerFilterSecurityMetadataSource developFilterSecurityMetadataSource;

	private final CustomizerAccessDecisionManager developAccessDecisionManager;

	public CustomizerSecurityInterceptor(CustomizerFilterSecurityMetadataSource developFilterSecurityMetadataSource,
			CustomizerAccessDecisionManager developAccessDecisionManager) {
