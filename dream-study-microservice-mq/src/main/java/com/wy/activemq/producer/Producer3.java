...
public class Producer3 {
	...
	public void sendMsg(String msg) {
		...
		// 发送到默认的点对点队列,不写destination,则发默认的destination
	...
	public void sendMsg() {
		// 自定义消息.不写destination,则发默认的destination
		jmsTemplate.send(new MessageCreator() {
	...
	/**
	 * 发布/订阅模式消息发布,主要是destination的实现类
	 * 
	 * @param destination 目标
	 */
	public void sendMsg(Destination destination) {
		// 点对点模式
