 ...
 * </pre>
 * 
 * {@link RabbitHandler}:表明被修饰的方法处理队列中消息
 * 
 * @author 飞花梦影
 * @date 2019-04-16 13:40:22
 * @git {@link https://github.com/dreamFlyingFlower}
 */
@RabbitListener(bindings = @QueueBinding(value = @Queue(value = "${mq.top.queue.logs}", autoDelete = "true"),
		exchange = @Exchange(value = "${mq.top.exchange}", type = ExchangeTypes.TOPIC), key = "*.log.*"))
@Component
