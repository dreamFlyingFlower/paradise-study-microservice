 ...
 * 
 * <pre>
 *{@link SocialAuthenticationFilter#attemptAuthenticatio}:拦截第三方登录请求
 * ->{@link SocialAuthenticationService}:Social登录验证服务
 * -->{@link OAuth2AuthenticationService#getAuthToke()}:从请求获取认证的令牌,失败会跳到默认的/signin页面
...
public class SocialConfig extends SocialConfigurerAdapter {
	...
	/**
	 * spring提供的注册工具类,会将授权服务器的信息提供给自定义的注册接口,见{@link UserCrl#getSocialUse()}
	 * 
